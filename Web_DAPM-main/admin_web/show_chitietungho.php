               ...
               <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                     ...
                     <ul class="breadcrumbs pull-left">
                        ...
                        <li><span>Chi tiết đăng kí ủng hộ</span></li>
                     </ul>
                  </div>
               </div>
                     ...
                     <div class="col-12">
                        <div class="card">
                           ...
                           <div class="card-body">
                              ...
                              <h4 style="text-align: center;" >Chi tiết đăng kí ủng hộ</h4>
                                 <div class="row" style="margin-bottom: 10px;">
                                 
                                    <div class="col-sm-12 col-md-6" >
                                    <a href="show_dangkiungho.php" class = "btn btn-warning">Quay về</a>
                                    </div>
                                       ...
                                       <table  id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                          <thead>
                                             <tr>
                                                ...
                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Sớ lượng</th>

                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Đơn vị</th>

                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Hình thức</th>
                                          ...
                                          <?php 
                                            ...
                                            $sql = "SELECT * FROM dangkyungho ,hangCuuTro, dotcuutro, chitietdangkyungho
                                            where dangkyungho.idDangKyungho = chitietdangkyungho.idDangkyungho
                                            and chitietdangkyungho.idHangCuuTro = hangcuutro.idHangCuutro
                                            and dangkyungho.idDotCuuTro = dotcuutro.idDotCuuTro
                                            and chitietdangkyungho.idDangKyUngHo = '$idDangKy' ";
                                            ...
                                            while ($row = $result->fetch_assoc()) 
                                            {
                                                ...
                                                <td><?php echo $row['tenHangCuuTro'] ?></td>
