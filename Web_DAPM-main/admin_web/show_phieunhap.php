                                       ...
                                       <table  id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                          <thead>
                                             <tr>
                                                ...
                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tên nhân viên</th>
                                                ...
                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Đợt cứu trợ</th>

                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Ngày nhâp</th>

                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Xem chi tiết</th>
                                          ...
                                          <tbody>
                                             <?php 
                                                ...
                                                $sql = "SELECT * FROM phieunhap, dangkyungho, dotcuutro,nhanvien
                                                where phieunhap.idDangKyUngHo = dangkyungho.idDangKyUngHo
                                                and dangkyungho.idDotCuuTro = dotcuutro.idDotCuuTro
                                                and phieunhap.idNhanVien = nhanvien.idNhanVien
                                                ORDER BY phieunhap.idPhieuNhap DESC";
                                             ...
                                             <tr>
                                                ...
                                                <th  style="text-align: center;">
                                                   <a href="show_chitietphieunhap.php?id=<?php echo $row["idPhieuNhap"] ?>" class="btn btn-warning" style="text-align: center;"> Xem chi tiết</a> 
                                                </th>
                                             </tr>
                                             <?php
                                                }
