                           ...
                           <div class="card-body">
                              ...
                              <h4 style="text-align: center;" >Chi tiết phiếu nhập</h4>
                                 <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <a href="show_phieunhap.php" class = "btn btn-warning">Quay về</a>
                                    </div>
                                       ...
                                       <table  id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                          <thead>
                                             <tr>
                                                ...
                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tên Hàng</th>

                                                <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Số lượng</th>
                                          ...
                                          <?php 
                                            ...
                                            $sql = "SELECT * FROM phieunhap ,hangcuutro, chitietphieunhap
                                            where phieunhap.idPhieuNhap = chitietphieunhap.idPhieuNhap
                                            and chitietphieunhap.idHangCuuTro = hangcuutro.idHangCuuTro
                                            and chitietphieunhap.idPhieuNhap = '$idphieunhap' ";
